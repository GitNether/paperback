  ...
  descriptions = {
    Joker = {
      ...
      j_paperback_pocket_pair = {
        name = "Карманная Пара",
        text = {
          "Зарабатывайте {C:money}$#1#{} за каждую {C:attention}#2-ку#{}, вытянутую",
          "в начале раунда"
        }
      },
      j_paperback_alert = {
      ...
      j_paperback_triple_moon_goddess = {
        ...
        text = {
          ...
          "{C:green}#1# из #2#{} шанс создать случайную карту {C:planet}Планеты{} и",
          "{C:green}#3# из #4#{} шанс создать случайную карту {C:purple}Таро{}",
        },
      },
      j_paperback_derecho = {
        name = "Деречо",
